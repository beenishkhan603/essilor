...
/* harmony export */ });
/* unused harmony exports b, h, j, k, l */
...
function updateSize() {
  ...
  // Subtract paddings
  width = width - parseInt((0,utils.m)(el, 'padding-left') || 0, 10) - parseInt((0,utils.m)(el, 'padding-right') || 0, 10);
  height = height - parseInt((0,utils.m)(el, 'padding-top') || 0, 10) - parseInt((0,utils.m)(el, 'padding-bottom') || 0, 10);
...
function updateSlides() {
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (slides[i] && (0,utils.m)(slide, 'display') === 'none') continue; // eslint-disable-line
...
function updateSlidesClasses() {
  ...
  if (activeSlide) {
    ...
    if (gridEnabled) {
      ...
      // Next Slide
      nextSlide = (0,utils.o)(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
      ...
      // Prev Slide
      prevSlide = (0,utils.p)(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
...
function loopCreate(slideRealIndex) {
  ...
  if (shouldFillGroup) {
    if (params.loopAddBlankSlides) {
      ...
      (0,utils.r)('Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
    ...
    if (params.loopAddBlankSlides) {
      ...
      (0,utils.r)('Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
    }
    initSlides();
  } else {
    initSlides();
...
function loopFix(_temp) {
  ...
  if (slides.length < slidesPerView + loopedSlides) {
    (0,utils.r)('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
  } else if (gridEnabled && params.grid.fill === 'row') {
    (0,utils.r)('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
  }
...
function setBreakpoint() {
  ...
  (0,utils.t)(swiper.params, breakpointParams);
...
function moduleExtendParams(params, allModulesParams) {
  return function extendParams(obj) {
    ...
    if (typeof moduleParams !== 'object' || moduleParams === null) {
      (0,utils.t)(allModulesParams, obj);
      return;
    }
...
class Swiper {
  constructor() {
    ...
    if (!params) params = {};
    params = (0,utils.t)({}, params);
    if (el && !params.el) params.el = el;
    const document = (0,ssr_window_esm.g)();
    if (params.el && typeof params.el === 'string' && document.querySelectorAll(params.el).length > 1) {
      const swipers = [];
      document.querySelectorAll(params.el).forEach(containerEl => {
        const newParams = (0,utils.t)({}, params, {
          el: containerEl
        });
    ...
    const swiperParams = (0,utils.t)({}, defaults, allModulesParams);

    // Extend defaults with passed params
    swiper.params = (0,utils.t)({}, swiperParams, extendedDefaults, params);
    swiper.originalParams = (0,utils.t)({}, swiper.params);
    swiper.passedParams = (0,utils.t)({}, params);
  ...
  mount(element) {
    ...
    Object.assign(swiper, {
      ...
      mounted: true,
      // RTL
      rtl: el.dir.toLowerCase() === 'rtl' || (0,utils.m)(el, 'direction') === 'rtl',
      rtlTranslate: swiper.params.direction === 'horizontal' && (el.dir.toLowerCase() === 'rtl' || (0,utils.m)(el, 'direction') === 'rtl'),
      wrongRTL: (0,utils.m)(wrapperEl, 'display') === '-webkit-box'
    });
    return true;
  }
  init(el) {
  ...
  static extendDefaults(newDefaults) {
    (0,utils.t)(extendedDefaults, newDefaults);
  }
