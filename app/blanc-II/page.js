              ...
              <div className={styles.header_content}>
                ...
                <div className={styles.second_row}>
                  {/* <img
                    ...
                    alt='eyexen logo'
                  /> */}
                  {/* <label className={styles.descrip} style={{ marginTop: "0.3rem", marginBottom: "1rem" }}>Balnc II</label> */}
                </div>
                <div className={styles.third_row} style={{ marginTop: "2rem" }}>
                  <p className={styles.descrip}>
                    {
                      'Starting around age 40, you might have trouble focusing on nearby objects or reading in dim light. This is called presbyopia and is a natural part of ageing. Balnc-II progressive lenses are designed for people aged 40+, offering sharp vision at every distance with seamless transitions from near to far.'
                    }
                  </p>
                </div>
              </div>
      ...
      <Grid direction='row' container>
        ...
        >
          ...
          <ol>
            ...
            <li>
              Protection against UV and blue-violet light filtering. (Blue-violet light is between 400 and 455nm as stated by ISO TR 20772:2018). 10. BlancTM in-Life Wearers Test - 3rd independent party - FRANCE - 2015 (n=76).
            </li>
