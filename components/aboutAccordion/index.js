    ...
    <div className={styles.main}>
      <div className={styles.mainSub}>
        <Grid container direction='row' height={'100%'}>
          ...
          >
            <p className={styles.heading}>About Belvin</p>
            <Accordion
              onChange={() => {
                if (accordionOpen2) {
            ...
            >
              ...
              <AccordionDetails className={styles.accordionDetail}>
                ...
                >
                  <Typography variant='p' className={styles.text}>
                    {`Belvin® lenses do more than correct your vision, because you're more than the numbers on your prescription. For us, an innovation is meaningless unless it has a real impact on your life and the health of your eyes.`}
                  </Typography>
                  <Typography variant='p' className={styles.text2}>
                    Discover Belvin® innovation.
                  </Typography>
                </div>
              </AccordionDetails>
            </Accordion>
